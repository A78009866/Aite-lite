...
const DEFAULT_PROFILE_PIC_URL = '/default-avatar.jpeg';
    ...
    const finalChats = chats.map(chat => {
      ...
      if (isBlockRelation) {
        contactProfile = {
          ...
          username: 'Aite user',
          full_name: 'Aite user',
          profile_picture_url: '/default-avatar.jpeg',
          is_online: false
        };
      }
    ...
    try {
        ...
        if (snapshot.exists()) {
            ...
            return res.json({
                ...
                profile_picture_url: profileData.profile_picture_url || '/default-avatar.jpeg'
            });
        }
      ...
      profileSnapshots.forEach(snap => {
        ...
        if (user && user.id) {
            ...
            usersList.push({
                ...
                profile_picture_url: isBlockRelation ? '/default-avatar.jpeg' : (user.profile_picture_url || DEFAULT_PROFILE_PIC_URL),
...
app.post('/api/marketplace/create', requireAuth, writeLimiter, (req, res, next) => {
  ...
  try {
    ...
    const productData = {
      ...
      sellerProfilePic: profile.profile_picture_url || '/default-avatar.jpeg',
